...
void ui_init(void)
{
    ...
    ui_Tela_Instrumento_screen_init();
    ui_Tela_Termometro_screen_init();
    ui_Tela_Oximetro_screen_init();
    ui_GSR_screen_init();
    ui_ECG_screen_init();
...
void ui_destroy(void)
{
    ...
    ui_Tela_Instrumento_screen_destroy();
    ui_Tela_Termometro_screen_destroy();
    ui_Tela_Oximetro_screen_destroy();
    ui_GSR_screen_destroy();
